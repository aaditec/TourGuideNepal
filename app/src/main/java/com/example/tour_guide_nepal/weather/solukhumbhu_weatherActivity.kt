package com.example.tour_guide_nepal.weather
...
class solukhumbhu_weatherActivity : AppCompatActivity() {
    val CITY: String = "Solukhumbu,np"
    val API: String = "e4c1f4bd657b624c4af61ab416c87a07" // Use API key
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_solukhumbhu_weather)
        weatherTask().execute()
