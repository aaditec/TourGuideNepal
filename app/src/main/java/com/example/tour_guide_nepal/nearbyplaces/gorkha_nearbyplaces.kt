...
class gorkha_nearbyplaces : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_gorkha_nearbyplaces)
    ...
    private fun getMyLatLong()
    {
        ...
        current_lat = 28.476395
        current_long = 84.689751
    ...
    private fun getPlaces(keyword: String)
    {
        ...
        {
            Log.d("gorkha nearby places","Exception: "+e)
        }
