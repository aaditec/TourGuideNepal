...
class tanahun_nearbyplaces : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_tanahun_nearbyplaces)
    ...
    private fun getMyLatLong()
    {
        ...
        current_lat = 28.030001
        current_long = 84.440002
    ...
    private fun getPlaces(keyword: String)
    {
        ...
        {
            Log.d("tanahu nearby places","Exception: "+e)
        }
